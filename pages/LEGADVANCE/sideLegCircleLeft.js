...
export default function SideLegCircleLeft() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.bgsetabs}>Side Leg Circles Left </h4>
          ...
          <div className={styles.backWard}>
            <Link href={"/LEGADVANCE/curtsyLunge"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          <div className={styles.forWard}>
            <Link href={"/LEGADVANCE/sideLegCircleRight"}>
              <MdArrowForwardIos />
            </Link>
          </div>
          <h5>4 out of 13</h5>
