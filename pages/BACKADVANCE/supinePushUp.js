...
export default function SupinePushUp() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.backAdvancedWorkOutName}>Supine Push-Ups</h4>
          ...
          <h5 className={styles.doneOutOfRemaining}>7 out of 10</h5>
        </div>
      </div>
    </div>
  );
