...
export default function SideFloorKickLeft() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.bgsetabs}>Side-Lying Stretch Left</h4>
          ...
          <div className={styles.forWard}>
            <Link href={"/BACKBEGINNER/sideFloorStretchRight"}>
              <MdArrowForwardIos />
            </Link>
          </div>
          <h5 className={styles.doneOutOfRemaining}>6 out of 12</h5>
        </div>
      </div>
    </div>
  );
