...
export default function SideArmRaises() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.backBeginnerWorkOutName}>Side Arm Raises</h4>
          ...
          <div className={styles.jumtim}>00:16</div>
          ...
          <div className={styles.backWard}>
            <Link href={"/BACKBEGINNER/rhomboidPulls"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          <div className={styles.forWard}>
            <Link href={"/BACKBEGINNER/kneePushUp"}>
              <MdArrowForwardIos />
            </Link>
          </div>
          <h5 className={styles.doneOutOfRemaining}>4 out of 12</h5>
        </div>
      </div>
    </div>
  );
