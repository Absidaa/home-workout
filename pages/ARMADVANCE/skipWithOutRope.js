      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.armAdvancedWorkOutName}>Skip Without Rope</h4>
          ...
          <div className={styles.backWard}>
            <Link href={"/ARMADVANCE/armCircleCounterClockwise"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          ...
          <h5 className={styles.doneOutOfRemaining}>3 out of 18</h5>
        </div>
      </div>
    </div>
  );
