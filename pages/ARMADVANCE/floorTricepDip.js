...
export default function FloorTricepDip() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.armAdvancedWorkOutName}>Floor Tricep Dips</h4>
          ...
          <h5 className={styles.doneOutOfRemaining}>7 out of 18</h5>
        </div>
      </div>
    </div>
  );
