...
export default function ShoulderGator() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.armAdvancedWorkOutName}>Shoulder Gators</h4>
          ...
          <div className={styles.backWard}>
            <Link href={"/ARMADVANCE/militaryPushUp"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          ...
          <h5 className={styles.doneOutOfRemaining}>10 out of 18</h5>
        </div>
      </div>
    </div>
  );
