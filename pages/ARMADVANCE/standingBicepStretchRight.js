...
export default function StandingBicepStretchRight() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.bgsetabs}>Standing Bicep Stretch Right</h4>
          ...
          <div className={styles.backWard}>
            <Link href={"/ARMADVANCE/standingBicepStretchLeft"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          ...
          <h5 className={styles.doneOutOfRemaining}>18 out of 18</h5>
        </div>
      </div>
    </div>
  );
