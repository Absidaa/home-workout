...
export default function ShoulderStretch() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.bgsetabs}>Shoulder Stretch</h4>
          ...
          <div className={styles.backWard}>
            <Link href={"/CHESTINTERMEDIATE/armCircles"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          <div className={styles.forWard}>
            <Link href={"/CHESTINTERMEDIATE/burpees"}>
              <MdArrowForwardIos />
            </Link>
          </div>
