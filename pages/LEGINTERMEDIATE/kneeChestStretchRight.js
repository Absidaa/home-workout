...
export default function KneeStretchRight() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.bgsetabs}>Knee Chest Stretch Right </h4>
          ...
          <div className={styles.forWard}>
            <Link href={"/LEGINTERMEDIATE/calvesRaiseSplayed"}>
              <MdArrowForwardIos />
            </Link>
          </div>
          <h5 className={styles.doneOutOfRemaining}>12 out of 17</h5>
        </div>
      </div>
    </div>
  );
