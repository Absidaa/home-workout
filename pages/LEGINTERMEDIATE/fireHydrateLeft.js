...
export default function FireHydrateLeft() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.bgsetabs}>Fire Hydrant Left </h4>
          ...
          <div className={styles.backWard}>
            <Link href={"/LEGINTERMEDIATE/squats"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          ...
          <h5 className={styles.doneOutOfRemaining}>3 out of 17</h5>
        </div>
      </div>
    </div>
  );
