...
export default function KneeStretchLeft() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.bgsetabs}>Knee To Chest Stretch Left </h4>
          ...
          <div className={styles.backWard}>
            <Link href={"/LEGINTERMEDIATE/rightQuadStretch"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          ...
          <h5 className={styles.doneOutOfRemaining}>11 out of 17</h5>
        </div>
      </div>
    </div>
  );
