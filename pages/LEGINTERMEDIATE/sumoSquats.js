...
export default function SumoSquats() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.legIntermediateWorkOutName}>Sumo Squats </h4>
          ...
          <div className={styles.forWard}>
            <Link href={"/LEGINTERMEDIATE/flutterKicks"}>
              <MdArrowForwardIos />
            </Link>
          </div>
          <h5 className={styles.doneOutOfRemaining}>6 out of 17</h5>
        </div>
      </div>
    </div>
  );
