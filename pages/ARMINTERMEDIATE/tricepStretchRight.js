...
export default function TricepStretchRight() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.bgsetabs}>Tricep Stretch Right</h4>
          ...
          <div className={styles.backWard}>
            <Link href={"/ARMINTERMEDIATE/tricepStretchLeft"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          <div className={styles.forWard}>
            <Link href={"/ARMINTERMEDIATE/standingBicepStretchLeft"}>
              <MdArrowForwardIos />
            </Link>
          </div>
