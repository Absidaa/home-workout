...
export default function SidePlankLeft() {
      ...
      <div className={styles.abdy}>
        <div className={styles.bbdy}>
          <div className={styles.absb}>
            ...
            <h4 className={styles.bgsetabs}>Side Plank Left</h4>
          ...
          <div className={styles.backWard}>
            <Link href={"/ABSADVANCE/bicycleCrunches"}>
              <MdArrowBackIosNew />
            </Link>
          </div>
          ...
          <h5 className={styles.doneOutOfRemaining}>7 out of 19</h5>
        </div>
      </div>
    </div>
  );
